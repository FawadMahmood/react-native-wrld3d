...
const Wrld3dView = /*#__PURE__*/(0, React.forwardRef)((props, forwardedRef) => {
  ...
  const publicRef = {
    setBuildingHighlight: (buildingId, color, buildingCoordinates) => {
      console.log('setting building hi', buildingId, color, buildingCoordinates);
  ...
  const tryMultiply = async () => {
    const aaa = await _Wrld3dLibrary.default.multiply(100, 200);
    console.log('output ios ghere', aaa);
  };
