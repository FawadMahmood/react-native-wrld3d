...
const Wrld3dView = /*#__PURE__*/(0, React.forwardRef)((props, forwardedRef) => {
  ...
  //mapevents
  const publicRef = {
    setBuildingHighlight: (buildingId, buildingCoordinates) => {
  ...
  const createBuildingHighlight = (0, React.useCallback)((buildingId, buildingCoordinates) => {
    console.log('setting building hi command', buildingId, buildingCoordinates);
    _Wrld3dViewNativeComponent.Commands.setBuildingHighlight(ref.current, buildingId, buildingCoordinates);
  }, []);
